...
clear
echo -e "${yellow}┌────────────────────────────────────────┐\e[0m"
echo -e "${yellow}│\e[0m                SETUP DOMAIN                          "
echo -e "${yellow}└────────────────────────────────────────┘\e[0m"
echo -e ""
echo -e "   ${green}1.\e[0m Menggunakan Domain Sendiri"
echo -e "   ${green}2.\e[0m Menggunakan Domain Script"
echo -e ""
echo -e "${yellow}└────────────────────────────────────────┘\e[0m"
echo -e ""
...
TEXT="
<code>────────────────────</code>
<b>⚠️<u>NOTIFIKASI INSTALL SCRIPT</u>⚠️</b>
<code>────────────────────</code>
...
<code>────────────────────</code>
<i>Nontifikasi Otomatis Dari <u>FV STORE bot</u></i>
...
echo ""
read -p "Press ${YELLOW}[ ${NC}${YELLOW}Enter${NC} ${YELLOW}]${NC} Ke menu" ; sleep 3 ; menu
esac